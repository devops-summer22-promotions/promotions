...
class TestPromotionModel(unittest.TestCase):
    ...
    def test_create_promotion(self):
        ...
        promo_1 = Promotion(name="Flash BOGO sale!", type=PromoType.BUY_ONE_GET_ONE, start_date=date.fromisoformat(
            "2022-07-01"), end_date=date.fromisoformat("2022-07-02"))
        self.assertEqual(
            str(promo_1), "<Promotion 'Flash BOGO sale!' id=[None]>")
        ...
        promo_2 = Promotion(name="20 pct off coupon", type=PromoType.PERCENT_DISCOUNT, discount=20,
                            start_date=date.fromisoformat("2022-07-01"), end_date=date.fromisoformat("2022-07-02"))
        self.assertEqual(
            str(promo_2), "<Promotion '20 pct off coupon' id=[None]>")
        ...
        promo_3 = Promotion(name="Free shipping July", type=PromoType.FREE_SHIPPING, start_date=date.fromisoformat(
            "2022-07-01"), end_date=date.fromisoformat("2022-07-31"))
        self.assertEqual(
            str(promo_3), "<Promotion 'Free shipping July' id=[None]>")
        ...
        promo_4 = Promotion(name="VIP customer 123 half off", type=PromoType.VIP, discount=50, customer=123,
                            start_date=date.fromisoformat("2022-07-01"), end_date=date.fromisoformat("2022-07-02"))
        self.assertEqual(
            str(promo_4), "<Promotion 'VIP customer 123 half off' id=[None]>")
